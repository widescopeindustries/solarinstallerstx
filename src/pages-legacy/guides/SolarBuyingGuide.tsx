  ...
  return (
    <>
      <SEOHead
        ...
        canonicalUrl="https://solarinstallerstx.com/learn/solar-buying-guide-texas"
        schema={{
          "@context": "https://schema.org",
          "@type": "HowTo",
          "name": "How to Buy Solar Panels in Texas",
          "description": "Complete guide to buying solar panels in Texas",
          "step": [
            {
              "@type": "HowToStep",
              "position": 1,
              "name": "Evaluate Your Home's Solar Potential",
              "text": "Assess roof condition, orientation, shading, and energy usage"
            },
            {
              "@type": "HowToStep",
              "position": 2,
              "name": "Calculate System Size and Cost",
              "text": "Determine the right system size based on your electricity consumption"
            },
            {
              "@type": "HowToStep",
              "position": 3,
              "name": "Research Installers",
              "text": "Find NABCEP certified installers with good reviews and local experience"
            },
            {
              "@type": "HowToStep",
              "position": 4,
              "name": "Get Multiple Quotes",
              "text": "Obtain at least 3 detailed quotes to compare pricing and equipment"
            },
            {
              "@type": "HowToStep",
              "position": 5,
              "name": "Review Financing Options",
              "text": "Compare cash purchase, solar loans, leases, and PPAs"
            },
            {
              "@type": "HowToStep",
              "position": 6,
              "name": "Sign Contract and Schedule Installation",
              "text": "Review contract terms carefully before signing"
            }
          ]
        }}
      />
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <div className="flex flex-col sm:flex-row gap-4 my-8">
              <Button asChild size="lg">
                <Link to="/quote">Get Free Solar Quotes</Link>
              </Button>
              <Button asChild variant="outline" size="lg">
                <Link to="/installers">Browse TX Installers</Link>
              </Button>
            </div>
          </article>
        </main>
...
export default SolarBuyingGuide;
