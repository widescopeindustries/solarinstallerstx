...
export default async function InstallerDetailPage({ params }: Props) {
    ...
    // Create typed objects for components
            ...
            <main className="container mx-auto px-4 py-12">
                ...
                <nav className="mb-6 text-sm" aria-label="Breadcrumb">
                    <ol className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <li>/</li>
                        <li>
                            <Link href={`/cities/${city}`} className="hover:text-primary transition-colors capitalize">
                                {city.replace(/-/g, ' ')}
                            </Link>
                        </li>
                        <li>/</li>
                ...
                <Link href="/installers" className="inline-flex items-center gap-2 text-primary hover:underline mb-6">
                            ...
                            <CardContent className="p-8">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-muted-foreground">
                                            {installer.services?.some((s: string) => s.toLowerCase().includes('battery') || s.toLowerCase().includes('storage'))
